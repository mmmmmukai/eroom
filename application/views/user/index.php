<?php require_once(APPPATH.'views/user/_header.php'); ?>
    <div class="video-contents">
        <div id="pc_mode">
          <video  autoplay loop  poster="/static/video/tompoederbachlasvegasblvdcopyforvimeobyphilipbloommp4.jpg" width="100%">
            <source src="/static/video/tompoederbachlasvegasblvdcopyforvimeobyphilipbloommp4.mp4">
            <source src="/static/video/tompoederbachlasvegasblvdcopyforvimeobyphilipbloommp4.ogv">
            <source src="/static/video/tompoederbachlasvegasblvdcopyforvimeobyphilipbloom.webm">
        ...
        <div class="main-top-img"id="sp_mode">
          <img src="/static/video/tompoederbachlasvegasblvdcopyforvimeobyphilipbloommp4.jpg">
        </div>
    </div>
    ...
    <article class="article-1">
      ...
      <div class="text-side-img"><img src="/static/images/photo_04.png"><img src="/static/images/photo_02.png"></div>
    ...
    <div class="gray">
      <div class="wrapper-gray">
       <div class="wrapper-gray-img">
         <img src="/static/images/photo_01.png">
         <p>ロゴの蝶です</p>
       </div>
       <div class="wrapper-gray-img">
         <img src="/static/images/photo_02.png">
         <p>ソファ席あります</p>
       </div>
       <div class="wrapper-gray-img">
         <img src="/static/images/photo_03.png">
         <p>落ち着いた雰囲気です</p>
       </div>
       <div class="wrapper-gray-img">
         <img src="/static/images/photo_04.png">
         <p>初心者でも気軽に</p>
         </div>
      </div>
    </div>
